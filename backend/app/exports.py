...
LEAD_EXPORT_FIELDS = [
    ...
    "first_contact_date", "last_contact_date", "next_followup_date", "outcome", "notes",
...
CALL_EXPORT_FIELDS = [
    ...
    "duration_seconds", "outcome", "contact_name", "contact_title", "objection", "notes", "next_step",
    "followup_date", "appointment_booked", "sale_amount", "created_at",
]
...
def consolidated_rows(leads: list[dict[str, Any]], calls: list[dict[str, Any]]) -> tuple[list[dict[str, Any]], list[str]]:
    ...
    for lead in leads:
        ...
        connected = sum(1 for call in lead_calls if call.get("outcome") not in non_contact)
